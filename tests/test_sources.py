...
class SourcesTest(unittest.TestCase):
    ...
    def setUp(self):
        ...
        '''
        self.new_source = Sources('CNN','CNN Business','Cable News Newtork that is a leader in providing news worldwide','cnn.com','general','U.S.A','en')
    ...
    def test_to_check_instance_variables(self):
        ...
        self.assertEquals(self.new_source.name,'CNN Business')
